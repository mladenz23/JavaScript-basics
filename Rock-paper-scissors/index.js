...
const playRound = function(humanChoice, computerChoice) {
  if (humanChoice === computerChoice){
    ...
    console.log(`You picked ${humanChoice}, computer picked ${computerChoice}. You lose!`);
    return 2;
  }
  else {
...
const playGame = function() {
  ...
  if (hScore > cScore)
    console.log(`Total score is ${hScore} : ${cScore} in favor of player. YOU WIN!!`);
  else if (hScore < cScore)
    console.log(`Total score is ${cScore} : ${hScore} in favor of computer. You lose.. :(`);
